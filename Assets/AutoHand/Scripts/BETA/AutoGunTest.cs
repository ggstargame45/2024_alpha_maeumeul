...
namespace Autohand {
    public enum SlideLoadTypeTest {
        HandLoaded,
        ShotLoaded
    }

    [Serializable] public class UnityGunHitEventTest : UnityEvent<AutoGunTest, RaycastHit> { }
    [Serializable] public class UnityGunEventTest : UnityEvent<AutoGunTest> { }
    [Serializable] public class UnityGunSlideEventTest : UnityEvent<AutoGunTest, SlideLoadTypeTest> { }
    [Serializable] public class UnityAmmoEventTest : UnityEvent<AutoGunTest, AutoAmmo> { }
    ...
    public class AutoGunTest : MonoBehaviour {
        ...
        public UnityGunEventTest OnShoot;
        public UnityGunEventTest OnEmptyShoot;
        public UnityGunHitEventTest OnHitEvent;
        public UnityAmmoEventTest OnAmmoPlaceEvent;
        public UnityAmmoEventTest OnAmmoRemoveEvent;
        public UnityGunSlideEventTest OnSlideEvent;
        ...
        public void LoadSlide() {
            OnSlideEvent?.Invoke(this, SlideLoadTypeTest.HandLoaded);
        ...
        public void FireLoadSlide() {
            OnSlideEvent?.Invoke(this, SlideLoadTypeTest.ShotLoaded);
            slideLoaded = loadedAmmo != null && loadedAmmo.currentAmmo > 0;
            if(slideLoaded)
                loadedAmmo.RemoveAmmo();
        ...
        protected virtual void OnHit(RaycastHit hit) {
            if(hit.rigidbody) {
                ...
                if(hit.rigidbody.TryGetComponent<AutoGunTargetTest>(out var target))
